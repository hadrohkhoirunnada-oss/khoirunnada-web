  ...
  return (
    <PageContainer className="space-y-6 pb-28 pt-0">
      <section className="relative isolate -mx-5 overflow-hidden px-5 pb-8 pt-7">
        <div className="pointer-events-none absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(245,197,66,0.08)_0%,rgba(245,197,66,0.035)_26%,rgba(0,0,0,0.08)_58%,rgba(0,0,0,0.18)_100%)]" />
        <div className="pointer-events-none absolute left-1/2 top-[-7rem] -z-10 h-80 w-[140%] -translate-x-1/2 rounded-full bg-amber-300/[0.075] blur-3xl" />
        <div className="pointer-events-none absolute right-[-7rem] top-20 -z-10 h-64 w-64 rounded-full bg-amber-300/[0.05] blur-3xl" />
        ...
        <div className="relative z-10">
          <div className="inline-flex max-w-[265px] items-center gap-3 rounded-2xl border border-amber-300/14 bg-black/30 px-3 py-2 shadow-lg shadow-black/20 backdrop-blur-xl">
          ...
          <p className="mt-5 max-w-[345px] text-[0.98rem] font-semibold leading-8 text-slate-300">
            Katalog produk, merchandise, perlengkapan majelis, dan kebutuhan
            Khoirunnada akan ditampilkan di halaman ini.
          </p>
